...
struct ContentView: View {
    ...
    var body: some View {
        VStack{
            ImageButton(start: 0, width: 200, height: 200, minVal: 0, maxVal: 127, speed: 0.5)
            Text("Speed 0.5")
            ImageButton(start: 60, width: 200, height: 200, minVal: 0, maxVal: 127, speed: 1)
            Text("Speed 1")
            ImageButton(start: 104, width: 200, height: 200, minVal: 0, maxVal: 127, speed: 1.5)
            Text("Speed 1.5")
        }
    }
}
